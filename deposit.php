            ...
            <div class="row">
               <div class="col-md-2 col-sm-4">
                  <div class="left-profile-box-m prod-page">
                     <div class="pro-img">
                        <img src="images/deposit.png" height="150" width="150" alt="#" />
                     </div>
                     <div class="pof-text">
                        <h3>XU Xiaochuan</h3>
               ...
               <div class="col-md-7 col-sm-8">
                  <div class="md-prod-page">
                     <div class="description-box">
                        <div class="dex-a">
                           <h4>Your rent for umbrella recipt</h4>
                           <p> Item: umbrella </p> 
                           <p>
                              Your due is 20/10, 18:00. Please pay attention
                           </p>
                           <br>
                           <h4>Your rent for cart recipt</h4>
                           <p> Item: cart </p> 
                           <p>
                              You have returned the item in time
                           </p>
               ...
               <div class="col-md-3 col-sm-12">
                  <div class="price-box-right">
                     ...
                     <h3>$ 20 will be charged if you didn't return the items in time</h3>
                     <h5></h5>
