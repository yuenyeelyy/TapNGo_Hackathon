...
$accountSettings1 = array(
    "merchantName" => "XU Xiaochuan",
    "appId" => "4247029993",
    // "appId" => "4292442886",
    // "appId" => "4299252236",
    "apiKey" => "IsrU8rk9sIkxLmVkb/PhqMjl5NTjMBj7gFLMmkasYMK9+QKymWxQhAKQOBVEhf0OVOBw/h083ohgahUBlBiNhQ==",
    // "apiKey" => "m05lusLh2EAP6S5d/PqfWusUIi8XXWIC3ER4vm/KY8DN4UD1e8UrJsx/yB3cFW88Msy1bsDTBM+FbK3Pq1/3uw==",
    // "apiKey" => "dZLS8fau86y+H9xpnfmQuJRf6/i0YvFlPXbs4b3+Pj78zPnlfEOuUdVl//K3BdZYa44Ukudu7cbwiILooPqCpA==",
    ...
    "notifyUrl" => "",
    "returnUrl" => "http://localhost/CP_Hackathon/air_conditioning_Paid.php",
