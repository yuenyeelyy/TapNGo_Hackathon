            ...
            <div class="container">
               <div class="row">
                  <ol class="breadcrumb">
                     ...
                     <li class="active">Over-nighting Visitor</li>
            ...
            <div class="row">
               <div class="col-md-2 col-sm-4">
                  <div class="left-profile-box-m prod-page">
                     <div class="pro-img">
                        <img src="images/night.jpeg" height = 150 width = 150 alt="#" />
                     </div>
                     <div class="pof-text">
                        
                                             </div>
                                          <?php include '_accountSettings2.php' ?>
                           <form action="testPaymentBackEnd2.php" method="post">
                  ...
                  <div class="price-box-right">
                     ...
                     <select class="form-control select2">
                        ...
                        <option value="KY">Kentucky</option>
                           ...
                           <p><?php include "_accountSettings2.php" ?>
