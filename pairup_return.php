                           ...
                           <div class="help-box">
                              <ul>
                                 ...
                                 <li> <a href="#"><img class="
                                    ...
                                    h-i" src="images/help-icon.png" alt="" /> Help </a> </li>
                              </ul>
                           </div>
                        </div>
            ...
            <div class="container">
               <div class="row">
                  <ol class="breadcrumb">
                     ...
                     <li class="active">Over-night Visitor</li>
            ...
            <div class="row">
               <div class="col-md-2 col-sm-4">
                  <div class="left-profile-box-m prod-page">
                     <div class="pro-img">
                        <img src="images/512x512bb.jpg" alt="#" />
                     </div>
                     <div class="pof-text">
                        
                                             </div>
                                          <?php include '_accountSettings3.php' ?>
                           <form action="testPaymentBackEnd3.php" method="post">
                              ...
                              <label></label><input type="hidden" name="totalPrice" value="0.01" /><br>
                              <label></label><input type="hidden" name="remark" value="remark" /><br>
                                 <input type="submit" value="Pair up"/>
                              <label></label><input type="hidden" name="paymentType" value="S" /><br>
                              <label></label><input type="hidden" name="lang" value="ZH"> 
                              <label></label><input type="hidden" name="currency" value="HKD" /><br>
                              <label></label>
                                                         </form>                 
                                       </div>
               </div>
                  ...
                  <div class="similar-box">
                     ...
                     <div class="row cat-pd">
                        <div class="col-md-6">
                           <div class="small-box-c">
                              <div class="small-img-b">
                                 <img class="img-responsive" src="images/tr1.jpg" alt="#" />
                              </div>
                              <div class="dit-t clearfix">
                                 <div class="left-ti">
                                    <h4>Machine 1</h4>
                                    <p>Hung Hom <span>in</span> 4 <span>1/F</span></p>
                                 </div>
                                 <a href="#" tabindex="0"></a>
                              </div>
                              <div class="prod-btn">
                        ...
                        <div class="col-md-6">
                           <div class="small-box-c">
                              <div class="small-img-b">
                                 <img class="img-responsive" src="images/PolyU_luandry.jpg" alt="#" />
                              </div>
                              <div class="dit-t clearfix">
                                 <div class="left-ti">
                                    <h4>Machine 2</h4>
                                    <p>Hung Hom in  <span>2/F</span></p>                                 </div>
                                 <a href="#" tabindex="0"></a>
                              </div>
                              <div class="prod-btn">
                                 <a href="#"><i class="fa fa-star" aria-hidden="true"></i> Save to wishlist</a>
                  ...
                  <div class="price-box-right">
                     ...
                     <select class="form-control select2">
                        ...
                        <option value="KY">Kentucky</option>
                           ...
                           <p><?php include '_accountSettings3.php' ?>
                           <form action="testPaymentBackEnd3.php" method="post">
                              ...
                              <br>
                              <label></label><input type="hidden" name="totalPrice" value="40" /><br>
                              <label></label><input type="hidden" name="remark" value="remark" /><br>
                              <label></label><input type="hidden" name="paymentType" value="S" /><br>
                              <label></label><input type="hidden" name="lang" value="ZH"> 
                              <label></label><input type="hidden" name="currency" value="HKD" /><br>
